    ...
    <body class="bg-blue-100 ">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Kontrak" :selected="statusKepemilikan === 'Kontrak'">2. Kontrak</option>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Sertifikat selain SHM(SHGB, SHSRS, Surat lainnya)" {{ old('BuktiKepemilikan', $dataBangunan->BuktiKepemilikan ?? '') == 'Sertifikat selain SHM(SHGB, SHSRS, Surat lainnya)' ? 'selected' : '' }}>4. Sertifikat selain SHM (SHGB, SHSRS, Surat lainnya)</option>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Parket/karpet" {{ old('JenisLantai', isset($dataBangunan) ? $dataBangunan->JenisLantai : '') == 'Parket/karpet' ? 'selected' : '' }}>3. Parket/karpet</option>
                                                <option value="Ubin" {{ old('JenisLantai', isset($dataBangunan) ? $dataBangunan->JenisLantai : '') == 'Ubin' ? 'selected' : '' }}>4. Ubin</option>
                                                <option value="Kayu" {{ old('JenisLantai', isset($dataBangunan) ? $dataBangunan->JenisLantai : '') == 'Kayu' ? 'selected' : '' }}>5. Kayu</option>
                                                <option value="Semen" {{ old('JenisLantai', isset($dataBangunan) ? $dataBangunan->JenisLantai : '') == 'Semen' ? 'selected' : '' }}>6. Semen</option>
                                                <option value="Bamboo" {{ old('JenisLantai', isset($dataBangunan) ? $dataBangunan->JenisLantai : '') == 'Bamboo' ? 'selected' : '' }}>7. Bamboo</option>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Kayu/papan/gypsum/GRC" {{ old('JenisDindingTerluas', isset($dataBangunan) ? $dataBangunan->JenisDindingTerluas : '') == 'Kayu/papan/gypsum/GRC' ? 'selected' : '' }}>3. Kayu/papan/gypsum/GRC</option>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Jerami/ijuk/daun" {{ old('JenisAtapTerluas', isset($dataBangunan) ? $dataBangunan->JenisAtapTerluas : '') == 'Jerami/ijuk/daun' ? 'selected' : '' }}>7. Jerami/ijuk/daun</option>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="PLN" {{ old('SumberPeneranganUtama', isset($dataBangunan) ? $dataBangunan->SumberPeneranganUtama : '') == 'PLN' ? 'selected' : '' }}>1. PLN</option>
                                                <option value="Non PLN" {{ old('SumberPeneranganUtama', isset($dataBangunan) ? $dataBangunan->SumberPeneranganUtama : '') == 'Non PLN' ? 'selected' : '' }}>2. Non PLN</option>
                                                <option value="Lainnya" {{ old('SumberPeneranganUtama', isset($dataBangunan) ? $dataBangunan->SumberPeneranganUtama : '') == 'Lainnya' ? 'selected' : '' }}>3. Lainnya</option>
                                            </select>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Gas Meteran GPN" {{ old('BahanBakarEnergiMemasak', isset($dataBangunan) ? $dataBangunan->BahanBakarEnergiMemasak : '') == 'Gas Meteran GPN' ? 'selected' : '' }}>5. Gas Meteran GPN</option>
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            ...
                                            >
                                                ...
                                                <option value="Septik tank" {{ old('TempatPembuanganAkhirTinja', isset($dataBangunan) ? $dataBangunan->TempatPembuanganAkhirTinja : '') == 'Septik tank' ? 'selected' : '' }}>1. Septik tank</option>
                                                ...
                                                <option value="Kolam/Sungai" {{ old('TempatPembuanganAkhirTinja', isset($dataBangunan) ? $dataBangunan->TempatPembuanganAkhirTinja : '') == 'Kolam/Sungai' ? 'selected' : '' }}>3. Kolam/Sungai</option>
                                                ...
                                                <option value="Tanah Lapang/Kebun" {{ old('TempatPembuanganAkhirTinja', isset($dataBangunan) ? $dataBangunan->TempatPembuanganAkhirTinja : '') == 'Tanah Lapang/Kebun' ? 'selected' : '' }}>5. Tanah Lapang/Kebun</option>
        ...
        <script>
            ...
            function toggleMeteranInputs() {
                ...
                const isPLN = sumberPenerangan === "PLN" || initialValue === "PLN";
