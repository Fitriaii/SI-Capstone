            ...
            <div class="flex min-h-screen">
                ...
                <div class="relative flex-1 px-8 rounded-2xl">
                    ...
                    <div class="flex items-center justify-between px-4 mt-4 text-blue-950">
                        <!-- Judul -->
                        <h1 class="text-xl font-semibold whitespace-nowrap">Data Kondisi Rumah</h1>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-xs font-medium text-center text-black whitespace-nowrap">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                <!-- Tombol Hapus -->
                                                <form method="POST" action="{{ route('bangunan.destroy', $dataBangunan) }}" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="px-6 py-4 text-sm text-center text-gray-500">Tidak ada data tersedia.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
