            ...
            <div class="relative flex-1 px-8 rounded-2xl">
                ...
                <div class="relative flex flex-col px-4 text-blue-950">
                    ...
                    <div class="w-full p-1 mx-auto mb-8 ">
                        <form id="userForm" action="" method="POST" class="space-y-3">
                            @csrf
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div>
                                        <input type="checkbox" id="tabung-gas">
                                        <label for="tabung-gas">Tabung Gas 5,5 kg atau Lebih</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="emas">
                                        <label for="emas">Emas/Perhiasan</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="lemari-es">
                                        <label for="lemari-es">Lemari Es/Kulkas</label>
                                    </div>
                                </div>
                            </div>
