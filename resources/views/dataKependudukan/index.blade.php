            ...
            <div class="relative flex-1 px-8 rounded-2xl">
                ...
                <div class="px-4 mt-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <form>
                            @csrf
                            <a href="/data-kependudukan/create" class="flex items-center px-4 py-2 space-x-2 text-xs font-semibold text-white transition duration-200 bg-blue-500 rounded-lg hover:bg-blue-600">
                        ...
                        <form id="downloadForm" action="{{ route('penduduk.export') }}" method="GET" target="_blank">
                            ...
                            >
                                ...
                                <span class="items-center justify-center inline-block w-4 h-4 text-green-500 bg-white rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 4h6v6m0 0l-6 6m6-6H10" />
                                    </svg>
                                </span>
                            </button>
                        </form>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-xs font-medium text-center text-black whitespace-nowrap">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <form method="POST" action="{{ route('penduduk.destroy', $dataKeluarga) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                                @csrf
                                                @method('DELETE')
